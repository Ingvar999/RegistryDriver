...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, RegistryQueueInitialize)
#endif

NTSTATUS
RegistryQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = RegistryEvtIoDeviceControl;
    queueConfig.EvtIoStop = RegistryEvtIoStop;
